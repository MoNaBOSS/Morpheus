...
if /i "%1"=="update" (
    echo openclaw is managed by Morpheus ^(bundled version^).
    echo.
    echo To update openclaw, update Morpheus:
    echo   Open Morpheus ^> Settings ^> Check for Updates
    echo   Or visit https://github.com/MoNaBOSS/Morpheus
    exit /b 0
)
...
set OPENCLAW_EMBEDDED_IN=Morpheus
...
if "%_USE_BUNDLED_NODE%"=="1" (
    ...
    "%~dp0..\..\Morpheus.exe" "%OPENCLAW_ENTRY%" %*
)
