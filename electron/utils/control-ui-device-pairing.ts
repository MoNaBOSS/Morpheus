...
/** Morpheus Gateway WebSocket client id used in connect frames. */
...
/** Loopback-only clients that Morpheus auto-approves without user interaction. */
